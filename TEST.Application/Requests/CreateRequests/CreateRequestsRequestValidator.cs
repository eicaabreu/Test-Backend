...
{
    internal class CreateRequestsRequestValidator : AbstractValidator<CreateRequestsRequest>
    {
        private readonly IApplicationDbContext _applicationDbContext;

        public CreateRequestsRequestValidator(IApplicationDbContext applicationDbContext)
        {
